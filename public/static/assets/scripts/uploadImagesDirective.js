angular.module('images', [])
  ...
  .directive('uploadImages',[
    ...
    function( $q, $filter, FireRef, notificationService , imagesService, CLOUDINARY_SITE_DEFAULT_IMAGES, CLOUDINARY_CLOUD_NAME){
      ...
      return {
        ...
        templateUrl: 'static/assets/views/directives/uploadImagesDirective.tpl.html',
        link: function (scope) {
